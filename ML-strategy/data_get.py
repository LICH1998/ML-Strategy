...
def init(context):
    ...
    start_date = '2014-01-01'  # SVM训练起始时间
    end_date = '2018-07-01'  # SVM训练终止时间
    # 用于记录工作日
    # 获取目标股票的daily历史行情
    recent_data = history(context.symbol, frequency='1d', start_time=start_date, end_time=end_date,
                          adjust=ADJUST_PREV, fill_missing='last', df=True)
    recent_data.to_csv('./data.csv')
    exit()
...
if __name__ == '__main__':
    ...
    '''
    run(strategy_id='c119df74-b2a9-11ed-a02d-00fff1ca1445',
